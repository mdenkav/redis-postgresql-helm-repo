...
#bu adımlar (grup sonu adımına kadar olan) manuel ilk kurulum sonrasında silinebilir.
cd /home/ec2-user/deniztest
helm create redis
helm create postgresql
touch README.md
touch all_infra_installation.sh
chmod 750 all_infra_installation.sh
#grup sonu.
